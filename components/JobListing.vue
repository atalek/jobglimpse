    ...
    <div class="w-full flex flex-col md:flex-row justify-between">
      <div
        ...
        <div class="relative flex-shrink-0">
          <img
            src="/bg-photo.webp"
            class="rounded-lg mt-2 border-2 h-16 w-16" />
          <Icon
            name="fa6-solid:star"
        ...
        <div class="ml-4 flex flex-col max-w-md">
          <h3 class="text-slate-600 text-sm">Company name</h3>
      ...
      <div class="flex items-center md:justify-end justify-center mt-2 md:mt-0">
        <button
          class="p-2 rounded-md w-24 text-lg bg-black text-white hover:bg-slate-800">
          Apply
        </button>
      </div>
    </div>
