...
<template>
  <section
    id="features"
    class="container text-center py-24 sm:py-32 text-balance">
    <h2 class="text-3xl md:text-4xl font-bold">How It Works</h2>
    <p class="md:w-4/4 mx-auto mt-4 mb-8 text-xl text-muted-foreground">
      Find Top Talent Fast: Discover Our Job Posting Process
    </p>
